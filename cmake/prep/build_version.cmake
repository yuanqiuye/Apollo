...
if((DEFINED ENV{BRANCH}) AND (DEFINED ENV{BUILD_VERSION}))  # cmake-lint: disable=W0106
    ...
    if(GIT_EXECUTABLE)
        ...
        if(NOT GIT_DESCRIBE_ERROR_CODE)
            ...
            if(APOLLO_APPEND_GIT_VERSION AND NOT GIT_DESCRIBE_BRANCH STREQUAL "master")
                set(PROJECT_VERSION ${PROJECT_VERSION}.${GIT_DESCRIBE_VERSION})
                MESSAGE("Sunshine Version: ${GIT_DESCRIBE_VERSION}")
            endif()
            if(APOLLO_APPEND_GIT_VERSION AND GIT_IS_DIRTY)
...
message("APOLLO_PRODUCT_NAME: ${APOLLO_PRODUCT_NAME}")
message("APOLLO_DEFAULT_PORT: ${APOLLO_DEFAULT_PORT}")

list(APPEND SUNSHINE_DEFINITIONS PROJECT_NAME="${APOLLO_PRODUCT_NAME}")
list(APPEND SUNSHINE_DEFINITIONS APOLLO_DEFAULT_PORT=${APOLLO_DEFAULT_PORT})
